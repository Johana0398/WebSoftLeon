...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link  href="css/styleHeader.css"  type="text/css" rel="stylesheet">
    ...
    <header>
        ...
        <a class="navbar-brand" href="index.php"><img src="img/Logo1.1.png" width="150" height="50" alt="" ></a>
            ...
            <ul class="navbar-nav mr-auto mb-2 mb-lg-0"> 
                <li class="nav-item"><a href="index.php" class="nav link options "> Inicio </a></li>        
                <li class="nav-item"><a href="Nosotros.php" class="nav link options"> Nosotros </a></li>
